...
public class PropertyCache
{
    ...
    public static void initPoperty()
    {
        ...
        try
        {
            endpointIs = PropertyCache.class.getResourceAsStream("/endpoint.properties");
            ...
            contextIs = PropertyCache.class.getResourceAsStream("/context.properties");
            // 上下文
            propFlies.load(contextIs);
            
            props = propFlies.entrySet();
            for (Map.Entry<Object, Object> prop : props)
            {
                properties.put(prop.getKey().toString(), prop.getValue());
            }
        ...
        {
            throw new MyRuntimeException("Startup failed...");
        }
        finally
        {
            propFlies.clear();
